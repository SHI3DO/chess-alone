def create():
    ...
    playerarray = ['white:rook:1', 'white:knight:1', 'white:bishop:1', 'white:king:1', 'white:queen:1', 'white:bishop:2',
                   'white:knight:2',
                   'white:rook:2']
    zeroarray1 = ['0:0:A1', '0:0:A2', '0:0:A3', '0:0:A4', '0:0:A5', '0:0:A6', '0:0:A7', 'black:knight:6']
    zeroarray2 = ['black:knight:4', 'black:knight:5', '0:0:B3', '0:0:B4', '0:0:B5', '0:0:B6', '0:0:B7', '0:0:B8']
    zeroarray3 = ['0:0:C1', '0:0:C2', '0:0:C3', '0:0:C4', '0:0:C5', 'black:knight:3', '0:0:C7', '0:0:C8']
